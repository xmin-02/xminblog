...
![](https://blog-api.xmin.blog/uploads/tistory-리눅스-커널-취약점-분석-환경-구성-커널-빌드-01-08f65a827079.png)
...
![](https://blog-api.xmin.blog/uploads/tistory-리눅스-커널-취약점-분석-환경-구성-커널-빌드-02-f4b94dce2a23.png)
...
![](https://blog-api.xmin.blog/uploads/tistory-리눅스-커널-취약점-분석-환경-구성-커널-빌드-03-dfef9a420b89.png)
...
![](https://blog-api.xmin.blog/uploads/tistory-리눅스-커널-취약점-분석-환경-구성-커널-빌드-04-76abd37678f3.png)
...
![](https://blog-api.xmin.blog/uploads/tistory-리눅스-커널-취약점-분석-환경-구성-커널-빌드-05-f3f9702c50e8.png)
...
![](https://blog-api.xmin.blog/uploads/tistory-리눅스-커널-취약점-분석-환경-구성-커널-빌드-06-9cd0a9e0fe36.png)

음... 도와줘요 GPT

여전히 로그를 살펴보니까 debian/canonical-certs.pem를 찾고 있어서 에러가 뜨는 것 같다. 예전 설정 혹은 캐시가 남아있어서 에러가 발생할 가능성이 크기에 어디서 참조되는지 즉시 확인한다.

![](https://blog-api.xmin.blog/uploads/tistory-리눅스-커널-취약점-분석-환경-구성-커널-빌드-07-1bdc9a0c3af1.png)
...
![](https://blog-api.xmin.blog/uploads/tistory-리눅스-커널-취약점-분석-환경-구성-커널-빌드-08-b9c2e5a211a5.png)
...
![](https://blog-api.xmin.blog/uploads/tistory-리눅스-커널-취약점-분석-환경-구성-커널-빌드-09-fcf9f61d50d6.png)
...
![](https://blog-api.xmin.blog/uploads/tistory-리눅스-커널-취약점-분석-환경-구성-커널-빌드-10-6cd72e9e0574.png)
...
![](https://blog-api.xmin.blog/uploads/tistory-리눅스-커널-취약점-분석-환경-구성-커널-빌드-11-3c75f1d0f718.png)

그러면 이런 화면이 뜨면 Advanced option for Ubuntu 클릭

![](https://blog-api.xmin.blog/uploads/tistory-리눅스-커널-취약점-분석-환경-구성-커널-빌드-12-ad7d838b6961.png)

설치한 커널 버전 클릭

![](https://blog-api.xmin.blog/uploads/tistory-리눅스-커널-취약점-분석-환경-구성-커널-빌드-13-ca94b12b5b22.png)
...
![](https://blog-api.xmin.blog/uploads/tistory-리눅스-커널-취약점-분석-환경-구성-커널-빌드-14-04d3e03f0574.png)
